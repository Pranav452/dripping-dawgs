      ...
      <div className="mx-auto max-w-7xl px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-4">
            <Link href="/" className="inline-block">
              <Image src="/LOGO.png" alt="Dripping Dawgs Logo" width={200} height={60} className="dark:invert" />
            </Link>
            <p className="text-sm text-gray-400">
              Elevate your style with premium streetwear that speaks volumes. Dripping Dawgs: Where fashion meets attitude.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 text-center sm:text-left mb-4 sm:mb-0">
            &copy; {currentYear} Dripping Dawgs. All rights reserved.
          </p>
          <div>
